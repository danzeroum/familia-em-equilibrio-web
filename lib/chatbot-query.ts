...
const QUESTION_PATTERNS = [
  ...
  /\bquem\b/i,
  /\bpor que\b/i,
  /\bcomo (está|estão|anda|ficou|fa[çc]o|fazer|posso|seria|ficaria)\b/i,
  /\b(me (diga|fala|mostra|lista|conta|diz|d[êe]|ajuda|ajude|explica|explique))\b/i,
  /\b(mostre?|verifique?|cheque?|confira?)\b/i,
  /\b(busque?|busca[r]?|procure?|procura[r]?|pesquise?|pesquisa[r]?|encontre?|ache?|acha[r]?)\b/i,
  /\b(d[êe]|dá|d[ãa]o)\s+(ideias?|sugest[õo]es?|dicas?|opç[õo]es?|exemplos?|conselhos?)\b/i,
  /\b(sugira|sugere|sugerir|recomende?|recomenda[r]?|indique?|indica[r]?)\b/i,
  /\b(ideias?|sugest[õo]es?|dicas?|opç[õo]es?)\s+(de|para|sobre|do|da)\b/i,
  /\b(explique?|explica[r]?|conte?|conta[r]?|descreva?|descreve[r]?)\b/i,
  /\b(ajude?|ajuda[r]?|me ajude?|me ajuda)\b/i,
